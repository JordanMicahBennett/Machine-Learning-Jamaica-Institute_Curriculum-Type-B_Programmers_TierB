![Alt Text](https://github.com/JordanMicahBennett/Machine-Learning-Jamaica-Institute_Curriculum-Type-B_Programmers_TierB/blob/master/data/logo.png)


# [MLJI](http://mlj-institute.appspot.com/) Curriculum Type B, Tier B (For programmers that know python, but don't know github)
## Course Code: "MLJI-CTBTB"
...
3. The last and fourth semester, concerning applying knowledge from the prior semesters, and attempting to **solve a problem faced by preferably the Jamaican country or elsewhere**. (The code/idea developed is yours, and is not the property of [MLJI](http://mlj-institute.appspot.com/).) 

![Alt Text](https://github.com/JordanMicahBennett/Machine-Learning-Jamaica-Institute_Curriculum-Type-B_Programmers_TierB/blob/master/data/time.png)
